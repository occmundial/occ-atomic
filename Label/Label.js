    ...
    _createClass(Label, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'label',
                { className: classes.label + ' ' + (theme ? classes[theme] : classes.default) + (onClick ? ' ' + classes.cursor : '') + (className ? ' ' + className : ''), id: id, style: style, onClick: onClick },
                children,
                onClose && _react2.default.createElement('span', { className: classes.close, onClick: function onClick(e) {
