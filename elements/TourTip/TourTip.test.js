...
describe("TourTip", function () {
    ...
    it('matches the snapshot', function () {
        var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_TourTip2.default, { classes: classes, direction: 'down' }));
...
describe("TourTipJSS", function () {
    ...
    it('matches the snapshot', function () {
        var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_index2.default, { direction: 'down' }));
        expect(wrapper).toMatchSnapshot();
    });
});
