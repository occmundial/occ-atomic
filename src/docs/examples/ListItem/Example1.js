...
export default function Example1() {
    return (
        <ul>
          <ListItem icon="check" iconColor={colors.prim} size="xLarge">
            <Text hero>Miembro 1</Text>
          </ListItem>
          <ListItem icon="check" iconColor={colors.prim} size="large">
            <Text headline>Miembro 2</Text>
          </ListItem>
          <ListItem icon="check" iconColor={colors.prim} size="medium">
            <Text heading>Miembro 3</Text>
          </ListItem>
          <ListItem icon="cross" iconColor={colors.error} size="base">
            <Text subheading>Miembro 4</Text>
          </ListItem>
          <ListItem icon="check">
            <Text>Miembro 5</Text>
          </ListItem>
          <ListItem icon="cross" iconColor={colors.secDark} size="small">
            <Text small>Miembro 6</Text>
          </ListItem>
          <ListItem icon="cross" size="small">
          ...
          <ListItem size="small" icon="cross">
