...
const Icons = ({ classes }) => (
	<div className={classes.page}>
		<Card shadow={3}>
			...
			<Text>
				The easiest way to implement the icons of the library is using the Icon
				component.
			</Text>
			<Text>
			...
			<ul>
				...
				<li>
					<Text>
						This icon function contains the svg of the icon, but can receive any
						color and inject it to its code.
					</Text>
				</li>
				<li>
					<Text>
						The colors must be inside an array, so the icon can inject the right
						color in the right place (in case of icons with more than one
						color).
					</Text>
				</li>
				<li>
