...
class NavItem extends React.Component {
    ...
    render() {
        const { classes, customComponent, customProps, link, onClick, children, selected, notification, white, small } = this.props;
        const AnchorTag = customComponent ? customComponent : 'a';
        return (
            <AnchorTag className={classes.link} href={!selected ? link : null} onClick={!selected ? onClick : null} {...customComponent && customProps}>
