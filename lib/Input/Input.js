...
class Input extends React.Component {
    ...
    setInputClassName() {
        ...
        if (type == "textarea") {
            ...
            if (value) inputClassName += ' ' + classes.expanded;
        }
    ...
    render() {
        ...
        const { input, classes, label, placeholder, counter, maxLength, type, options, name, id, style, disabled, meta, autoFocus, error, valid, clear, iconName } = this.props;
