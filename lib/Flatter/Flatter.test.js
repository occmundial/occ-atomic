...
const htmlTextExample = `<p class="c01601 c01604 c01620 c01636">Descripción</p><div><pre class="ql-syntax" spellcheck="false">GRUPO GAYOSSO, EMPRESA LÍDER Y PIONERA EN SERVICIOS FUNERARIOS, RECONOCIDA COMO UNA DE LAS MEJORES EMPRESAS PARA TRABAJAR, TE INVITA A INTEGRARTE A SU EQUIPO DE TRABAJO COMO:
...
describe("Flatter", () => {
    ...
    it('matches the snapshot', () => {
        const wrapper = shallow(
            <Flatter classes={classes} htmlText={htmlTextExample} />
        );
