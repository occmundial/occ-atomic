...
const Tag = ({ classes, children, className, style, theme, iconName,size }) => (
	<label
		className={`${size ? classes[size] : classes.standard} ${
	...
	>
		{iconName && (
			<span
				className={`${size? classes[`${size}Icon`] : classes.standardIcon} ${
...
Tag.propTypes = {
	...
	size:  PropTypes.oneOf([
		tagSizes.standard,tagSizes.medium,tagSizes.big	])
};
