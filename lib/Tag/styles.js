...
const iconHeight = 13,
	paddingStandardTag = [1, tiny, 2, tiny],
	paddingMediumTag = [6, gutter, tiny, gutter],
	paddingBigTag = [7, small, 9, small],
	tagTextLineHeight = 1.4,
	tagTextStandardSize = 10,
	tagTextMediumSize = 14,
	tagTextBigSize = 16,
	bigIconSizes = {
		width: 19,
		height: 20
...
export default {
	...
	bigIcon: {
		width: bigIconSizes.width,
		height: bigIconSizes.height
	},
	defaultIcon: {
		background: props =>
