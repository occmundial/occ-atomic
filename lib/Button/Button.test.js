...
describe("Button styles", () => {
    ...
    it('returns the right icons', () => {
        ...
        expect(styles.secondary['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICMwOTQ2Q0I=)');
        expect(styles.secondary['&:hover, &:active']['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICMwOTQ2Q0I=)');
