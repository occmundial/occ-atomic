...
describe("Button styles", () => {
    ...
    it('returns the right icons', () => {
        ...
        expect(styles.main['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.secondary['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZjQ1NmE=) no-repeat center center');
        expect(styles.secondary['&:hover']['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.secondary['&:active']['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.flat['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZjQ1NmE=) no-repeat center center');
        expect(styles.flat['&$disabled']['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNiZmJmYmY=) no-repeat center center');
        expect(styles.blue['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.disabled['& i'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
    });
