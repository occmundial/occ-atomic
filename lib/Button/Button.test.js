...
describe("Button styles", () => {
    ...
    it('returns the right icons', () => {
        ...
        expect(styles.main['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.secondary['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZjQ1NmE=) no-repeat center center');
        expect(styles.secondary['&:hover']['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.secondary['&:active']['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.flat['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZjQ1NmE=) no-repeat center center');
        expect(styles.flat['&$disabled']['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNiZmJmYmY=) no-repeat center center');
        expect(styles.blue['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
        expect(styles.disabled['& $icon'].background(props)).toBe('url(data:image/svg+xml;base64,dGVzdGluZyAtICNmZmZmZmY=) no-repeat center center');
    });
