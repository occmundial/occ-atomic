...
export default {
    ...
    secondary: {
        ...
        '&:hover, &:active': {
            ...
            '& i': {
                background: props => props.icon ? icons.base(icons[props.icon].icon([colors.secDark])) : ''
            }
        },
        '& i': {
            background: props => props.icon ? icons.base(icons[props.icon].icon([colors.sec])) : ''
        },
        '&$disabled': {
    ...
    tertiary: {
        ...
        '&:hover, &:active': {
            ...
            '& i': {
                background: props => props.icon ? icons.base(icons[props.icon].icon([colors.grey600])) : ''
            }
        },
        '& i': {
            background: props => props.icon ? icons.base(icons[props.icon].icon([colors.grey900])) : ''
        },
        '&$disabled': {
    ...
    ghostWhite: {
        ...
        '& i': {
            background: props => props.icon ? icons.base(icons[props.icon].icon([colors.bgWhite])) : ''
        },
        '&$disabled': {
            background:`transparent !important`,
