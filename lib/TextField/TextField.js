        ...
        if (disabled) {
            ...
            passIcon = (
                <div className={classes.passIcon}>
                    <Icon iconName="eyeSolid" width={iconSizes.small} height={iconSizes.small} colors={[colors.grey100]} />
                </div>
            );
        } else if (type == "select") {
            element = (
            ...
            passIcon = (
                <div onMouseDown={this.togglePass} onMouseUp={this.focusInput} onMouseOut={this.outOfPassIcon} className={classes.passIcon}>
                    <Icon iconName="eyeSolid" width={iconSizes.small} height={iconSizes.small} colors={showPass ? [colors.grey500] : [colors.grey200]} />
                </div>
            );
        }
