...
class TextField extends React.Component {
    ...
    setInputClassName() {
        const { classes, iconName, clear, type, inputClassName, alignRight } = this.props;
    ...
    render() {
        ...
        const { classes, input, meta, label, placeholder, counter, maxLength, type, name, options, id, style, disabled, autoFocus, error, assistiveText, clear, iconName, allowError, lockHeight, required, mask, guide } = this.props;
                ...
                <div className={classes.inputWrap}>
                    ...
                    {type == 'select' && (
                        <div className={classes.selectIcon}>
                            <Icon iconName="arrowDown" width={18} height={18} colors={disabled ? [colors.grey200] : [colors.grey900]} />
                        </div>
                    )}
