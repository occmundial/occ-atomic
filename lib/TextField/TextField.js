...
class TextField extends React.Component {
    ...
    render() {
        ...
        const { classes, input, meta, label, placeholder, counter, maxLength, type, name, id, style, disabled, autoFocus, error, assistiveText, clear, iconName, allowError, lockHeight } = this.props;
