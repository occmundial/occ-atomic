        ...
        if (disabled) {
            ...
            passIcon = (
                <div className={classes.passIcon}>
                    <Icon iconName="eyeClosed" width={iconSizes.small} height={iconSizes.small} colors={[colors.grey200]} />
                </div>
            );
        } else if (type == "select") {
            element = (
            ...
            passIcon = (
                <div onMouseDown={this.togglePass} onMouseUp={this.focusInput} onMouseOut={this.outOfPassIcon} className={classes.passIcon}>
                    <Icon iconName={showPass ? "eye" : "eyeClosed"} width={iconSizes.small} height={iconSizes.small} colors={showPass ? [colors.grey900] : [colors.grey400]} />
                </div>
            );
        }
