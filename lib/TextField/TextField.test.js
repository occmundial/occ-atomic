...
describe("TextField", () => {
    ...
    it('shows a counter with the number of characters written', () => {
        const wrapper = shallow(
            <TextField classes={classes} maxLength={50} label="Label" counter />
        );
        expect(wrapper.find('.counter').length).toBe(1);
        expect(wrapper.find('.counter').text()).toBe('0 / 50');
    ...
    it('shows the TextField with an error', () => {
        const wrapper = shallow(
            <TextField classes={classes} assistiveText="This field has an error" error />
        );
    ...
    it('validates with the regex', () => {
        const wrapper = shallow(
            <TextField regex="^[0-9]*$" classes={classes} />
        );
    ...
    it('renders as a SearchField', () => {
        const wrapper = shallow(
            <TextField searchField classes={classes} />
        );
