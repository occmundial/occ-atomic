...
describe("TextField", () => {
    ...
    it('shows the TextField with an error', () => {
        ...
        const errorAssistiveText = `.${classes.errorAssistiveText}`;
        ...
        expect(wrapper.find(error).at(0).prop('className').indexOf('container') > -1).toBe(true);
    });
