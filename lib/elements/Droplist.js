...
class Droplist extends React.Component {
    ...
    render() {
        ...
        const { classes, items, groups, groupNameKey, groupIdKey, groupItemsKey, itemTextKey, itemTextRightKey, itemIdKey, onClick } = this.props;
        return (
