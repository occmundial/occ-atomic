		...
		return (
			<div
				className={`${classes.overlay} ${
					show ? classes.overlayShow : classes.overlayHide
					...
					<div className={classes.cardBlock} onClick={this.avoidClose}>
						<Card
							...
							className={`${classes.card}${size ? ` ${classes[size]}` : ''}${
								show ? ` ${classes.cardShow}` : ` ${classes.cardHide}`
							}`}
						>
										...
										<div className={classes.bottom}>
											{secBtn && (
												<Button
													...
													id={secBtn.id}
													{...(testId && {
														'data-testid': `${testId}__button_secondary`
													})}
												>
													{secBtn.text}
												</Button>
											...
											<Button
												...
												id={mainBtn.id}
												{...(testId && {
													'data-testid': `${testId}__button_main`
												})}
											>
												{mainBtn.text}
											</Button>
