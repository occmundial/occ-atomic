...
export default {
    ...
    cardWrapper: {
        ...
        [`@media screen and (max-width:${grid.xxs}px)`]: {
            width: ({fullSize}) => fullSize === true && '100%',
        }
    },
    cardBlock: {
        margin: spacing.gutter,
        [`@media screen and (max-width:${grid.md}px)`]: {
            margin: ({fullSize}) => fullSize === true && 0
        }
    },
    card: {
        maxWidth:'100%',
        ...
        [`@media screen and (max-width:${grid.md}px)`]: {
            padding: ({fullSize}) => fullSize === true && spacing.medium,
            minHeight: ({fullSize}) => fullSize === true && '100vh',
            borderRadius: ({fullSize}) => fullSize === true && 0
        }
    },
    cardShow: {
