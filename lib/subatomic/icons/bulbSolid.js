...
export default {
    ...
    icon: (color = [colors.grey900]) => (
		...
		<path fill="${color[0]}" d="M8.7,19h6.6v-0.7c0-0.8,0.4-1.6,1-2.1l0,0c1.5-1.3,2.4-3.2,2.4-5.2c0-3.7-3-6.8-6.8-6.8c-3.7,0-6.8,3-6.8,6.8
			c0,2,0.9,4,2.5,5.2c0.6,0.5,1,1.3,1,2.1C8.7,18.3,8.7,19,8.7,19z"/>
		</svg>`
    )
};
