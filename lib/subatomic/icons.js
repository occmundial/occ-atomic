...
export default {
    ...
    check: {
        ...
        icon: function(color = [colors.white]){return (
            ...
            <path fill="${color[0]}" d="M6.5,11.8C6.4,11.9,6.2,12,6.1,12s-0.3-0.1-0.4-0.2L3.1,9.3c-0.2-0.2-0.2-0.5,0-0.7l0.2-0.2
            	c0.2-0.2,0.5-0.2,0.7,0c0,0,0,0,0,0l2,2l5.9-6c0.2-0.2,0.5-0.2,0.7,0c0,0,0,0,0,0l0.2,0.2c0.2,0.2,0.2,0.5,0,0.7L6.5,11.8z"/>
            </svg>`
        );}
    },
    search: {
