...
export default {
    ...
    bell: {
        ...
        icon: function(color = [colors.pink]) {return (
            `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            	 viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
            <path fill="${color[0]}" d="M12.3,20.5c1.2,0,2.2-0.3,2.2-2H10C10,20.2,11,20.5,12.3,20.5z"/>
            <path fill="${color[0]}" d="M17.4,15v-4.5c0-2.5-1.8-4.7-4.1-5.2V4.7c0-0.7-0.5-1.2-1.2-1.2S10.8,4,10.8,4.7v0.6C8.4,5.8,6.6,8,6.6,10.5V15
            	L5,16.7v0.8h14v-0.8L17.4,15z"/>
            </svg>`
        );}
    },
    studies: {
