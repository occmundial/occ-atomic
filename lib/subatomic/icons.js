...
export default {
    ...
    eye: {
        ...
        icon: function(color = [colors.black]) {return (
            `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            	 viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
            <path fill="${color[0]}" d="M12,9.3c-2,0-3.6,1.6-3.6,3.6s1.6,3.6,3.6,3.6s3.6-1.6,3.6-3.6S14,9.3,12,9.3z M10.2,15.3
            	c-0.7,0-1.2-0.5-1.2-1.2c0-0.7,0.5-1.2,1.2-1.2c0.7,0,1.2,0.5,1.2,1.2C11.4,14.7,10.9,15.3,10.2,15.3z M12.3,13.5
            	c-0.2,0-0.3-0.1-0.3-0.3c0-0.2,0.1-0.3,0.3-0.3c0.2,0,0.3,0.1,0.3,0.3C12.6,13.4,12.5,13.5,12.3,13.5z"/>
            <path fill="${color[0]}" d="M1.2,13.2c-0.2,0-0.3-0.1-0.3-0.3c0-0.1,0-0.1,0-0.1c1.8-3.2,6.2-5.2,11-5.2s9.2,2,11,5.2
            	c0.1,0.1,0,0.3-0.1,0.4c-0.1,0.1-0.3,0-0.4-0.1c-1.7-3-5.9-4.9-10.5-4.9S3.2,10.1,1.5,13C1.4,13.1,1.3,13.2,1.2,13.2z"/>
            </svg>`
        );}
    },
    like: {
