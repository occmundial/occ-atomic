...
export default {
    ...
    appstore: {
        ...
        icon: function(color = [colors.white]) {return (
            `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            	 viewBox="0 0 12 12" style="enable-background:new 0 0 12 12;" xml:space="preserve">
            <path fill="#FFFFFF" d="M7.9,3.4c1.1,0,1.8,1.1,1.8,1.1S8.7,5,8.7,6.3c0,1.5,1.3,1.9,1.3,1.9s-1.1,2.5-2.2,2.5c-0.7,0-0.7-0.4-1.6-0.4
            	c-0.8,0-1,0.4-1.6,0.4C3.4,10.8,2,8.3,2,6.3c0-2.1,1.5-2.9,2.4-2.9c0.8,0,1.1,0.5,1.8,0.5C6.7,3.8,7.1,3.4,7.9,3.4z"/>
            <path fill="#FFFFFF" d="M7.8,1.3c0.2,1-0.8,2.3-1.8,2.2C5.7,2.2,6.9,1.3,7.8,1.3z"/>
            </svg>`
        );}
    },
    sight: {
