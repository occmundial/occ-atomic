      ...
      >
        <div className={classes.checkWrap}>
          <div className={classes.check} id={trk}>
            ...
            {undetermined && (
              <Icon iconName="minus" width={16} height={16} colors={[colors.icon.inverse.default]} className={classes.icon} />
            )}
            {!undetermined && value &&
              <Icon iconName="check" width={16} height={16} colors={[colors.icon.inverse.default]} className={classes.icon} />
            }
          </div>
        </div>
        {!!(label || right) && (
