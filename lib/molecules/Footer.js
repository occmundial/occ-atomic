...
const styles = {
    ...
    androidIcon: {
        width:icons.android.width,
        height:icons.android.height,
        display:icons.android.display,
        background:icons.base(icons.android.icon)
    },
    appleIcon: {
        width:icons.apple.width,
        height:icons.apple.height,
        display:icons.apple.display,
        background:icons.base(icons.apple.icon)
    }
}
