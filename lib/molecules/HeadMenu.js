...
const styles = {
    ...
    listItem: {
        ...
        position:'relative',
        '&:hover $dashboard': {
            background:icons.base(icons.dashboard.icon([colors.darkerBlue]))
        },
        '&:hover $publications': {
            background:icons.base(icons.publications.icon([colors.darkerBlue]))
        },
        '&:hover $talent': {
            background:icons.base(icons.talent.icon([colors.darkerBlue]))
        },
        '&:hover $listAnchor': {
    ...
    activeItem: {
        '& $dashboard, &:hover $dashboard': {
            background:icons.base(icons.dashboard.icon([colors.white]))
        },
        '& $publications, &:hover $publications': {
            background:icons.base(icons.publications.icon([colors.white]))
        },
        '& $talent, &:hover $talent': {
            background:icons.base(icons.talent.icon([colors.white]))
        },
