...
class Input extends React.Component {
    ...
    render() {
        ...
        const { input, classes, className, label, placeholder, counter, maxLength, type, name, id, disabled, meta, autoFocus, error, valid, clear, selectOnFocus, iconName } = this.props;
        ...
        if (disabled) {
            return (
                <div className={`${classes.container} ${classes.disabled} ${(!label && placeholder) && classes.push}${className ? ` ${className}` : ''}`}>
                    {label && (
        ...
        return (
            <div className={`${classes.container} ${classes[realStatus]} ${(!label && placeholder) && classes.push}${className ? ` ${className}` : ''}`}>
                ...
                <input
                    ...
                    name={name}
                    id={id}
                    className={`${classes.input}${iconName ? ` ${classes.hasIcon}` : ''}${clear ? ` ${classes.hasClear}` : ''}`}
