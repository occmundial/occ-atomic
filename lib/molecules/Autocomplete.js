...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const { classes, id, type, name, label, placeholder, selectOnFocus, items, groups, groupNameKey, groupIdKey, groupItemsKey, itemTextKey, itemTextRightKey, itemIdKey, onClick, stackLabels, limit, limitPlaceholder } = this.props;
        const cleanItems = this.removeSelected();
        return (
            <div className={classes.autoComplete} id={id}>
                <Input
