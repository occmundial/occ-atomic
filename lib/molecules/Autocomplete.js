...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const { classes, id, type, name, label, placeholder, iconName, selectOnFocus, items, groups, groupNameKey, groupIdKey, groupItemsKey, itemTextKey, itemTextRightKey, itemIdKey, onClick, stackLabels, limit, limitPlaceholder, style } = this.props;
