...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const { classes, type, name, label, placeholder, items, groups, groupNameKey, groupIdKey, groupItemsKey, itemTextKey, itemTextRightKey, itemIdKey, onClick, stackLabels, limit, limitPlaceholder } = this.props;
