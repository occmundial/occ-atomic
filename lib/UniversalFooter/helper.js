...
const contentArrays = {
  ...
  socialMedia: [
    ...
    {
      item: "youtube",
      link: "https://www.youtube.com/user/OCCMundial",
      id: "2"
    },
  ...
  classification: [
    {
      item: "Vacantes por Estado »",
      link: `${base}/empleos-por-estado`,
      id: "1"
    },
    {
      item: "Vacantes por Ciudad »",
      link: `${base}/empleos-por-ciudad`,
      id: "2"
    },
    {
      item: "Vacantes por Categoría »",
      link: `${base}/empleos-por-categoria`,
      id: "3"
    },
    {
      item: "Vacantes más buscadas »",
      link: `${base}/empleos-mas-buscados`,
      id: "4"
    },
    {
      item: "Vacantes por Contrato »",
      link: `${base}/empleos-por-contratacion`,
      id: "5"
    },
    {
      item: "Vacantes por Empresa »    ",
      link: `${base}/empleos-por-empresa`,
      id: "6"
    },
    {
      item: "Buscar Empleo en México y el mundo",
      link: `${base}/empleos`,
      id: "7"
    }
  ]
...
export const selectArray = (arrayName, filter = [], extra = []) => {
  ...
  filter.map(key => (selected = selected.filter(({ id }) => id !== key)));
