...
class SlideDown extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.expanded !== expanded && this.state.expanded !== expanded) {
            this.toggleContent();
        }
    }
    ...
    render() {
        ...
        const { classes, title, children, tag, textSize } = this.props;
        const getTextSize = () => {
            switch (textSize) {
                    ...
                    <Flexbox display="flex" justifyContent="between" alignItems="start">
                        <Flexbox display="flex" alignItems="center">
                            <Flexbox display="flex" alignItems="start" wrap="wrap">
                                <div>
                                    <Text {...getTextSize()} tag="label" className={classes.text}>{title}</Text>
