...
describe("SlideDown", () => {
    ...
    it('Text have the right properties', () => {
        const wrapper = shallow(
            <SlideDown classes={classes} textProps={textProps}>Children content</SlideDown>
        );
        expect(wrapper.find(Text).props().heading).toEqual(textProps.heading);
        expect(wrapper.find(Text).props().success).toEqual(textProps.success);
        expect(wrapper.find(Text).props().large).toEqual(textProps.strong);
        expect(wrapper.find(Text).props().tag).toEqual(textProps.tag);
