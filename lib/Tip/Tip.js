        ...
        <div id={id} className={className} style={style}>
            ...
            >
                <Flexbox display="flex" flex="1" justifyContent={center ? 'center' : null} alignItems="center">
                    {icon && <Icon iconName={getIconName()} className={classes.icon} colors={[colors[theme]]} />}
                ...
                {onClose && <Icon iconName="cross" onClick={onClose} colors={[colors[theme]]} className={spacedClose ? classes.spacedClose : null} />}
            </Flexbox>
        </div>
    );
};
