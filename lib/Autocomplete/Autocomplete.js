...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const { classes, id, inputProps, droplistProps, onClick, stackLabels, limit, limitPlaceholder, className, style } = this.props;
        const cleanItems = this.removeSelected();
        return (
            <div className={`${classes.autoComplete}${className ? ` ${className}` : ''}`} id={id} style={style}>
                <Input
