...
class Autocomplete extends React.Component {
    ...
    componentDidMount() {
        if (process.env.NODE_ENV === 'development') {
            console.warn('DEPRECATED: The Autocomplete component is using deprecated components. While we work in a new solution, use a combination of the TextField and Droplist components instead.');
        }
    }
