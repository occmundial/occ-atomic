...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const { classes, id, textfieldProps, droplistProps, className, style,showInitialData } = this.props;
        const showDropList = showInitialData ? focus && droplistProps.items : value && focus && droplistProps.items
        return (
