...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const { classes, id, textfieldProps, droplistProps, className, style,showRecentSearches } = this.props;
        const showDropList = showRecentSearches ? focus && droplistProps.items : value && focus && droplistProps.items
        return (
