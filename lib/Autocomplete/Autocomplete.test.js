...
describe("Autocomplete", () => {
    ...
    it('renders the input and droplist', () => {
        const wrapper = mount(
            <Autocomplete textfieldProps={{valueProp:'a', className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
    ...
    it('filters the items of the droplist using the input value', () => {
        const wrapper = mount(
            <Autocomplete textfieldProps={{className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
    ...
    it('returns the input value', () => {
        ...
        const wrapper = mount(
            <Autocomplete onChange={onChange} textfieldProps={{className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
    ...
    it('returns the object of the selected item', () => {
        ...
        const wrapper = mount(
            <Autocomplete onMouseDown={onMouseDown} textfieldProps={{valueProp:'a', className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
        wrapper.setState({focus: true});
        wrapper.find('.Droplist-item-0-1-29').at(0).simulate('mousedown');
        expect(onMouseDown.mock.calls[0][0]).toEqual({id: 1, text: 'Administrador', textRight: '(222)'});
        wrapper.setState({focus: true, value:'a'});
        wrapper.find('.Droplist-item-0-1-29').at(1).simulate('mousedown');
    ...
    it('calls the onChange function', () => {
        const onChange = jest.fn();
        const wrapper = mount(
            <Autocomplete onChange={onChange} textfieldProps={{valueProp:'a', className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
        wrapper.find('input').simulate('change', {target: {value:'a'}});
    ...
    it('calls the onFocus function', () => {
        ...
        const wrapper = mount(
            <Autocomplete onFocus={onFocus} textfieldProps={{valueProp:'a', className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
    ...
    it('calls the onBlur function', () => {
        ...
        const wrapper = mount(
            <Autocomplete onBlur={onBlur} textfieldProps={{valueProp:'a', className:'input'}} droplistProps={{items, className:'droplist'}} classes={classes} />
        );
