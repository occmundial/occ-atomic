...
import { MenuListContext } from '../Provider/MenuListProvider';
...
class MenuItem extends React.Component {
  ...
  render() {
    ...
    const isDense = typeof dense === 'undefined' ? this.context.dense : dense;
    ...
    leftIconContainerClasses += dense
    ...
    rightIconContainerClasses += dense
      ? ` ${classes.iconContainerSizeDense}` : ` ${classes.iconContainerSize}`;
